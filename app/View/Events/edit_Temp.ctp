...
<div class="events form">
    <?php echo $this->Form->create('Tempevent',array('controller'=>'Events','action' => 'simpan2'));?>
    <fieldset>

        <?php

        echo $this->Form->input('fasilitas_id');
        echo $this->Form->input('Tempevent.id',array('type'=>'hidden'));
        echo $this->Form->input('Booker.nama_depan');
        echo $this->Form->input('Booker.id',array('type'=>'hidden'));
        echo $this->Form->input('Booker.nama_belakang');
        echo $this->Form->input('Booker.email');
        echo $this->Form->input('Booker.telepon');
