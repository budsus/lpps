...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Html->link(__('Hapus Event', true), array( 'action' => 'delete', $event['Event']['id']), null, sprintf(__('Are you sure you want to delete this %s event?', true), $event['Facility']['nama'])); ?> </li>
