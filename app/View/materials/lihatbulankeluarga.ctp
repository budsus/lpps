...
<h6>Daftar Material Masa Bulan Keluarga</h6>
...
<table>
	...
	<?php 
		...
		foreach($data as $m):
			 if($m['Material']['event'] == 'BulanKeluarga' && $m['Material']['tahun'] == '2014'){
	?>
...
<table>
	...
	<?php 
		...
		// jika sudah ada data akun user
		foreach($data as $m):
			 if($m['Material']['event'] == 'BulanKeluarga' && $m['Material']['tahun'] == '2015'){
	?>
...
<table>
	...
	<?php 
		...
		// jika sudah ada data akun user
		foreach($data as $m):
			 if($m['Material']['event'] == 'Bulan Keluarga' && $m['Material']['tahun'] == '2016'){
	?>
...
<table>
	...
	<?php 
		...
		// jika sudah ada data akun user
		foreach($data as $m):
			 if($m['Material']['event'] == 'BulanKeluarga' && $m['Material']['tahun'] == '2017'){
	?>
