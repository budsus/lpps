...
<div class="eventTypes index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $facility['Facility']['nama']; ?>&nbsp;</td>
        <td><?php echo $facility['Facility']['color']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('plugin' => 'full_calendar', 'action' => 'view', $facility['Facility']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('plugin' => 'full_calendar', 'action' => 'edit', $facility['Facility']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
